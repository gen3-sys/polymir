...
export const config = {
    ...
    centralDB: {
        ...
        port: getInt('CENTRAL_DB_PORT', 1111),
        database: getOptional('CENTRAL_DB_NAME', 'polymir_central'),
        user: getOptional('CENTRAL_DB_USER', 'postgres'),
        password: getOptional('CENTRAL_DB_PASSWORD', ''),
    ...
    worldDB: {
        ...
        port: getInt('WORLD_DB_PORT', 1111),
        database: getOptional('WORLD_DB_NAME', 'polymir_world'),
        user: getOptional('WORLD_DB_USER', 'postgres'),
        password: getOptional('WORLD_DB_PASSWORD', ''),
    ...
    jwt: {
        ...
        expiresIn: getOptional("JWT_EXPIRES_IN", "7d"), // 7 days default
        algorithm: "HS256"
    },
